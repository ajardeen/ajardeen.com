...
function CommandInput({
  ...
  return (
    <div data-slot="command-input-wrapper" className=" pb-0">
      <InputGroup className="bg-transparent! border-x-transparent border-t-transparent border-b-input/30 h-12! rounded-none shadow-none! *:data-[slot=input-group-addon]:pl-2!">
