      ...
      <div className={className}>
        <div className="flex items-center hover:bg-muted/50!">
          ...
          <div className="flex-1 border-l border-dashed border-edge">
            <CollapsibleTrigger className="flex w-full items-center gap-2 p-4 pr-2 text-left cursor-pointer">
        ...
        <CollapsibleContent className="group overflow-hidden data-[state=closed]:animate-collapsible-up data-[state=open]:animate-collapsible-down">
