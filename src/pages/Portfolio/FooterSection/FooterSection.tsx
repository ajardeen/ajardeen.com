...
import FooterRevealSection from "./FooterRevealSection";
import { motion } from "framer-motion";
function FooterSection() {
  return (
    <>
      <footer className="max-w-screen overflow-x-hidden screen-line-after  bg-background">
        <div className="screen-line-before  mx-auto border-x border-edge pt-4 md:max-w-3xl">
          <p className="mb-1 px-4 text-center font-mono text-sm text-balance text-muted-foreground">
            Inspired by ui.shadcn.com, chanhdai.com & apple.com
          </p>
      ...
      <motion.div className="sticky bottom-0 -z-10 h-[300px]">
        <FooterRevealSection />
      </motion.div>
    </>
  );
